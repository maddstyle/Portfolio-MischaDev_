			...
			<?php else:?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
						...
						<?php if(!empty($drex_options['src-page-title'])): ?>
                        <?php echo esc_html(($drex_options['src-page-title']));?>
							<?php else :?>
							<?php esc_html_e('Search','drex');?>
							<?php endif;?>
                        </h1><!-- page title end -->
                       ...
                       <?php printf( esc_attr__( 'Results for : "%s"', 'drex' ), '' . get_search_query() . '' ); ?>
                    ...
                    <div class="<?php echo esc_attr($drex_disable_wid_left);?>">
						...
						<!-- Begin blog list item -->
											<article class="blog-list-item isotope col-1">
												...
												<div class="bl-item-info wr-blog-item-list">
													<div class="bl-item-category"><?php the_category(', ') ?></div>
													<a href="#0" class="bl-item-title"><h2><?php if(!empty($drex_options['translet_opt_23'])):?><?php echo esc_html(drex_AfterSetupTheme::return_thme_option('translet_opt_23',''));?><?php else: ?><?php esc_html_e('No Post Found','drex');?><?php endif;?></h2></a>
						...
						<div class="news-item">
						<h2 class="section-heading section-heading-all section-heading-light section-heading-news">
                        <?php if(!empty($drex_options['translet_opt_23'])):?><?php echo esc_html(drex_AfterSetupTheme::return_thme_option('translet_opt_23',''));?><?php else: ?><?php esc_html_e('No Post Found','drex');?><?php endif;?>
                        </h2>
						</div>
						<?php endif;?>
						<?php endif;?>
